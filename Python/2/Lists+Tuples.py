...
#(1,3) =
#[1,2,3,4,5] =
#("Bat","dog","lemur","monkey") =
#["I" "like", "Lemurs", "and", "monkeys"] =
#[("lemur",10),("dog", 15), ("cat", 1), ("bat", 23)] =
...
#Why can't I add more data to a Turple?
#Write anwser here

#Create a list of animals below containing. Save it to a variable called zoo.

#print(zoo)

#Print the lenght of this List
